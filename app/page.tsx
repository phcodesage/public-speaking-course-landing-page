  ...
  const courseLevels: CourseLevel[] = [
    {
      ...
      color: '#0e1f3e',
      price: '$439',
      stripeLink: 'https://securelink-prod.valorpaytech.com:4430/?redirect=1&uid=a07475d6-5304-11f1-a8e1-12a0879a85b1',
      showDate: true,
      ...
      crashCourse: {
        ...
        price: '$139',
        stripeLink: 'https://securelink-prod.valorpaytech.com:4430/?redirect=1&uid=72731237-5304-11f1-a8e1-12a0879a85b1',
        showDate: true,
      }
    },
    {
